...
<head>
    ...
    <style>
        /* Gradient Animation */
        .navbar {
            background: linear-gradient(270deg, #005672, #00773e , #009f84) !important; /* Set background */
            background-size: 400% 400%;
            animation: gradient 10s ease infinite;
            border-radius: 0 !important; /* Remove any radius */
        }
        ...
        .navbar-toggler, .dropdown-menu, .btn, .nav-link {
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="paperlist.php">Paper List</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="course.html" id="navbarDropdown" role="button" aria-expanded="false">
                        Course
                    </a>
            ...
            <!-- Right-side profile and logout dropdown -->
